...
function initializeTinyMceMentions(editor, usersCallback) {
  if(!Object.hasOwn(editor, 'clientflowCommands')) {
    editor.clientflowCommands = {}
  }

  let cachedUsers = null;

  editor.clientflowCommands.getUsersForMention = async function() {
  ...
  editor.clientflowCommands.insertMentionUser = function (id, name, rng) {
  ...
  editor.ui.registry.addAutocompleter('mentions', {
    ...
    fetch: function (pattern) {
      return new Promise(resolve =>
          resolve(editor.clientflowCommands.getUsersForMention())
      )
    },

    // Executed when user is selected from the dropdown
    onAction: function (autocompleteApi, rng, value) {
      editor.clientflowCommands.getUsersForMention().then(users=> {
        let user = users.find(user=>user.value == value)
        editor.clientflowCommands.insertMentionUser(value, user.text, rng)
