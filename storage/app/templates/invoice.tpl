...
<p>Esta Factura es un comprobante de pago pero no representa una factura comercial avalada por ninguna entidad gubernamental o secretaria o administracion de rentas, es responsabilidad de cada comercio afiliado a nuestro plan de revendedores emitir una factura oficial segun sea las leyes de renta del pais, conctartar al vendedor para solicitar mas informacion en caso de requerir una factura comercial avalada por una entidad de administracion de rentas.</p>
</body>
</html>