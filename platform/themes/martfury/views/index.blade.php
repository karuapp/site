...
<div class="container">
    <div style="margin: 40px 0;">
        <h4 style="color: #f00; margin-bottom: 15px;">¡Primero debes configurar tu página de inicio!</h4>

        <p><strong>1. Vaya a Administrador -> Complementos y luego active todos los complementos..</strong></p>
        <p><strong>2. Vaya a Administrador -> Páginas y cree una página.:</strong></p>
        ...
        <div style="margin: 20px 0;">
            ...
            <br>
            <div>- Plantilla: <strong>Página principal</strong>.</div>
        </div>

        <p><strong>3. Luego vaya a Administrador -> Apariencia -> Opciones de tema -> Página para configurar su página de inicio..</strong></p>
    </div>
</div>
