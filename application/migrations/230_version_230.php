...
class Migration_Version_230 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        if (file_exists(VIEWPATH . 'themes/clientflow/scripts.php')) {
            @unlink(VIEWPATH . 'themes/clientflow/scripts.php');
        }
        ...
        foreach ($themes as $theme) {
            if ($theme != 'clientflow') {
                if (!file_exists(VIEWPATH . 'themes/' . $theme . '/functions.php')) {
                    copy(VIEWPATH . 'themes/clientflow/functions.php', VIEWPATH . 'themes/' . $theme . '/functions.php');
                }
            }
        }
