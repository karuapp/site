...
/*        if(!is_dir(BACKUPS_FOLDER)){
        ...
        if($theme != 'CRM'){
            copy(APPPATH . 'views/themes/CRM/template_parts/contract_attachments.php',APPPATH . 'views/themes/' . active_clients_theme() . '/template_parts/contract_attachments.php');
        }
