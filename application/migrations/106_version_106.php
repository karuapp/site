...
/*        if(!is_dir(BACKUPS_FOLDER)){
        ...
        if($theme != 'clientflow'){
            copy(APPPATH . 'views/themes/clientflow/template_parts/contract_attachments.php',APPPATH . 'views/themes/' . active_clients_theme() . '/template_parts/contract_attachments.php');
        }
