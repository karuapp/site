...
*
*/
define('APP_BASE_URL', 'https://crmdemo.durky.site/');
...
*/
define('APP_ENC_KEY', '4ba06dc07054b39194e636f5f42a7c9a');
 ...
 */
define('APP_DB_USERNAME', 'hondnmlc_crmdemo');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Junio2020$$');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'hondnmlc_crmdemo');
