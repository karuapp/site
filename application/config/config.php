...
if (file_exists(APPPATH . 'config/app-config.php')) {
    ...
    $install_url .= 'install';
    echo '<h1>clientflow CRM not installed</h1>';
    echo '<p>1. To you use the automatic clientflow CRM installation tool click <a href="' . $install_url . '">here (' . $install_url . ')</a></p>';
