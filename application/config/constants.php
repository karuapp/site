 ...
 */
define('UPDATE_URL', 'https://www.clientflowcrm.com/clientflow_updates/index.php');

/**
 * Get latest version info
 */
define('UPDATE_INFO_URL', 'https://www.clientflowcrm.com/clientflow_updates/update_info.php');
